...
<ul>
     ...
     <li style="float:right"><h2><font face="times new roman" size="6">Welcome,
       ...
       ?>
       !&nbsp&nbsp<button class="logout"><a href="/training_system/logout.php">Logout</a></button></font></h2></li> 
</ul>
</div>
...
echo"</table>"
   ...
   <br>
    <center><a href="adminHomepage.php"><button type="submit" name="back"><font face="times new roman">Back to home</font></button></a></center>
</div>
</body>
</html>
