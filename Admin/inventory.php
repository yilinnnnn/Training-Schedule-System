...
<center><button type="submit" name="update" value="update inventory">Update inventory</button></form>

<a href="adminHomepage.php"><input type="submit" name="back" value="Back to home"></a></center>
