...
if(isset($_POST['update'])){
    ...
    //once schedule is edited status will change
    $query="UPDATE schedule SET status='Approved', lastChangedOn='$date', lastChangedBy='$_SESSION[username]' WHERE id='$id'";
...
<div class="main">
    ...
    <table style="width:100%" class="table2">
        ...
        <h2><button type="submit" name="update" value=<?php echo $id;?> style="margin-left:180px">Update</button> &nbsp&nbsp
