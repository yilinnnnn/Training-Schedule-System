...
echo "<label class="heading">Select book to restock: </label>";
...
<center><button type="submit" name="edit" value="edit inventory">Edit inventory</button>&nbsp&nbsp
<button type="submit" name="back" value="back to home">Back to home</button></center>
</form>
</body>
</html>